...
function log() {
    ...
    set +u; declare -A level_priority=([debug]=1 [info]=2 [warn]=3 [error]=4); set -u
    ...
    # Define log colors
    set +u; declare -A colors=([debug]="\033[1m\033[38;5;63m" [info]="\033[1m\033[38;5;87m" [warn]="\033[1m\033[38;5;192m" [error]="\033[1m\033[38;5;198m"); set -u
